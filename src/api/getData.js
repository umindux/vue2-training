...
export const login = (data) =>
    fetch("https://portal.insuremo.com/cas/ebao/v1/json/tickets", data, "POST");
...
export const rendertasksNew = (data) =>
    fetch(
        "https://portal-gw.insuremo.com/eBao/1.0/rendertasks/new",
        data,
        "POST"
    );

export const clouddisObjectList = (data) =>
    fetch(
        "https://portal-gw.insuremo.com/eBao/1.0/clouddisk/object/list",
        data,
        "POST"
    );

export const clouddisObjectGetobject = (data) =>
    fetch(
        "https://portal-gw.insuremo.com/eBao/1.0/clouddisk/object/getobject",
        data,
        "POST"
    );

export const clouddisObjectPutobject = (data) =>
    fetch(
        "https://portal-gw.insuremo.com/eBao/1.0/clouddisk/object/putobject",
        data,
        "POST"
    );
